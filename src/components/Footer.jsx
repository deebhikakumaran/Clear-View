    ...
    <footer className="bg-[#1A1F2C] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Clear View</h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="/map-view" className="text-gray-300 hover:text-white">Map</a>
              </li>
              <li>
                <a href="/report" className="text-gray-300 hover:text-white">Report</a>
              </li>
            </ul>
          </div>
          ...
          <div>
              ...
              <div className="space-y-3">
                <p className="text-gray-300">Email: support@clearview.com</p>
